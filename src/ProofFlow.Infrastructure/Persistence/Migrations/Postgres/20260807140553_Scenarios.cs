        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CanvasJson = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromPort = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    ToNodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    ToPort = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowConnections_ScenarioVersionId_FromNodeId_FromPort_T~",
                table: "WorkflowConnections",
